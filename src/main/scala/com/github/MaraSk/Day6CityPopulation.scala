...
object Day6CityPopulation extends App {
  ...
  // write a function (name it yourself) to calculate Fahrenheit from Celsius
  //f = 32 + c*9/5
  ...
  def celsiusToFahrenheit(celsius: Double, precision: Int = 2): Double = {
    ...
    MyTools.myRound(32 + celsius * 9 / 5, precision) //so I am returning already rounded and calculated value
  }
  ...
  // 2nd main TASK - not really related to first task
  println("Function to calculate city growth")
  // write a function getCityYear which takes the following 4 parameters
